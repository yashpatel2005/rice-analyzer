...
class CellposeSegmenter:
    ...
    def _init_model(self):
        ...
        try:
            ...
            self._model = models.CellposeModel(model_type=self.model_type, device=self.device)
            logger.info(f"Cellpose {self.model_type} model loaded successfully on {self._model.device}")
...
def create_cellpose_segmenter(**kwargs) -> CellposeSegmenter:
    ...
    return CellposeSegmenter(
        ...
        use_tta=kwargs.get("use_tta", True),
